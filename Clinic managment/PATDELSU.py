...
def Search_button():
    global inp_s,entry,errorS,t,i,q,dis1,dis2,dis3,dis4,dis5,dis6,dis7,dis8,dis9,dis10,rootS
...
def Emp_search():
    global inp_s,entry,errorS,t,i,q,dis1,dis2,dis3,dis4,dis5,dis6,dis7,dis8,dis9
    global l1,l2,l3,l4,l5,l6,l7,l8,l9,l10
    c1=conn.cursor()
    inp_s=entry.get()
    p=list(c1.execute('select * from employee where EMP_ID=?',(inp_s,)))
    if (len(p)==0):
        errorS=tkinter.Label(rootS,text="PATIENT RECORD NOT FOUND")
        errorS.pack()
    else:
        t=c1.execute('SELECT * FROM employee  where EMP_ID=?',(inp_s,));
        for i in t:
            l1=tkinter.Label(rootS,text="Employee ID",fg='green',font='bold')
            dis1=tkinter.Label(rootS,text=i[0])
            l2=tkinter.Label(rootS,text="Employee NAME",fg='green',font='bold')
            dis2=tkinter.Label(rootS,text=i[1])
            l3=tkinter.Label(rootS,text="Employee SEX",fg='green',font='bold')
            dis3=tkinter.Label(rootS,text=i[2])
            l4=tkinter.Label(rootS,text="Employee Age",fg='green',font='bold')
            dis4=tkinter.Label(rootS,text=i[3])
            l5=tkinter.Label(rootS,text="Employee Type",fg='green',font='bold')
            dis5=tkinter.Label(rootS,text=i[4])
            l6=tkinter.Label(rootS,text="Employee Salary",fg='green',font='bold')
            dis6=tkinter.Label(rootS,text=i[5])
            l7=tkinter.Label(rootS,text="Experience",fg='green',font='bold')
            dis7=tkinter.Label(rootS,text=i[6])
            l8=tkinter.Label(rootS,text="Employee Contact NO",fg='green',font='bold')
            dis8=tkinter.Label(rootS,text=i[7])
            l9=tkinter.Label(rootS,text="Employee Email",fg='green',font='bold')
...
def E_display():
    ...
    rootS=tkinter.Tk()
    rootS.title("SEARCH WINDOW")
    head=tkinter.Label(rootS,text="ENTER Employee ID TO SEARCH",fg="red")
    entry=tkinter.Entry(rootS)
    searchB=tkinter.Button(rootS,text='SEARCH',command=Emp_search)
    menubar= tkinter.Menu(rootS)
    filemenu = tkinter.Menu(menubar, tearoff=0)
